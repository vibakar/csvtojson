...
d3.json("../outputdata/male_female_life_expectancy.json",function(err,data){
 data.forEach(function(d){
   d.year=+d.year;
   d.male_life_expectancy=+d.male_life_expectancy;
   d.female_life_expectancy=+d.female_life_expectancy;
 });
var xData=["male_life_expectancy","female_life_expectancy"];
